    ...
    >
      <div className="relative z-0 flex w-full flex-1 scale-y-125 items-center justify-center">
        <motion.div
          ...
          className="bg-gradient-conic absolute inset-auto right-1/2 h-56 w-[30rem] from-cyan-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
          <div className="absolute inset-x-0 bottom-0 z-20 h-40 w-full bg-slate-950 [mask-image:linear-gradient(to_top,white,transparent)]" />
      ...
      <div className="relative z-50 -translate-y-60 flex flex-col items-center px-5 text-center pt-32">
        {children}
      </div>
    </div>
  )
